...
def initialize_voxels():
    ...
    for i in range(4):
        create_block(ivec3(-40, -(i + 1)**2 - 41, -40), ivec3(80, 2 * i + 1, 80), vec3(0.5 - i * 0.1) * vec3(1.0, 0.8, 0.6), vec3(0.05 * (3 - i)))
    create_block(ivec3(-40, -41, -40), ivec3(80, 1, 80), vec3(0.3, 0.2, 0.1), vec3(0.01))
